    ...
    <div>
      ...
      <div className="container px-5 py-24 mx-auto flex">
        <div className="lg:w-1/3 md:w-1/2 w-full bg-white rounded-lg p-8 flex flex-col md:ml-auto mt-10 md:mt-0 relative z-10">
          ...
          <textarea
            className="bg-white rounded border border-gray-400 focus:outline-none h-32 focus:border-gray-500 focus:ring-1 focus:ring-gray-500 text-base px-4 py-2 mb-5 resize-none"
            placeholder="Message..."
          ></textarea>

          <CustomButton
            title="Send Feedback"
            containerStyle={`w-full block bg-black text-white px-6 py-2.5 text-md rounded hover:bg-gray-800 focus:outline-none flex-col items-center`}
          />

          <p className="text-xs text-gray-500 mt-4">
            We normally reply feedbacks within 2 business days.
          </p>
        </div>
      </div>
    </div>
