      ...
      <div className=" border-t border-gray-200 py-4">
        ...
        <div className="container mx-auto px-5 pt-6 pb-8 flex flex-wrap  items-center justify-between">
          ...
          <span className="inline-flex lg:ml-auto lg:mt-0 mt-6 w-full justify-center md:justify-start md:w-auto">
            <a className="text-gray-500 text-xl hover:text-gray-600 hover:scale-125 ease-in-out duration-300">
              <FaFacebookF />
            </a>
            <a className="ml-3 text-gray-500 text-xl hover:text-gray-800 hover:scale-125 ease-in-out duration-300">
              <FaTwitter />
            </a>
            ...
            <a className="ml-3 text-gray-500 text-xl hover:text-gray-600 hover:scale-125 ease-in-out duration-300">
              <FaLinkedinIn />
            </a>
          </span>
        </div>
