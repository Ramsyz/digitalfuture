...
const Header = () => {
  return (
    <>
      <div className="container mx-auto flex flex-col items-center py-8 2xl:pt-20 md:flex-row">
        <div className="md:w-1/2 md:pr-16 flex flex-col mb-16 md:mb-0 lg:flex-grow lg:pr-24">
          <h1 className="text-3xl md:text-4xl mb-4 font-bold text-slate-600 leading-[3rem] 2xl:leading-[4rem]">
            KodeCraft Solutions <br />
          ...
          <div className="flex">
            <CustomButton
              title="Get Started"
              containerStyle={`bg-black text-white px-6 py-3 font-semibold text-lg rounded-md hover:bg-gray-800`}
              iconRight={<BsArrowUpRight size={25} />}
            />
          </div>
        </div>

        <div className="relative md:w-1/2 w-full h-[400px] md:h-[500px] flex items-center justify-center lg:max-w-xl">
          <Image
            src="/hero.jpg"
            width={500}
            height={500}
          ...
          />
          <div className="absolute bg-white p-2 shadow-2xl rounded-lg left-0 top-6 flex items-center gap-2 cursor-pointer hover:scale-105 ease-in-out duration-300">
          ...
          <div className="absolute bg-white p-2 shadow-2xl rounded-lg right-0 bottom-6 flex items-center gap-2 cursor-pointer hover:scale-105 ease-in-out duration-300">
            <div className="w-[42px] h-[42px] rounded-full">
              <Image
                src="/sam.png"
                width={38}
          ...
          >
            {({ countUpRef }) => (
              <div className="flex flex-col items-center justify-center border border-slate-300 w-[250px] h-[250px] rounded-lg">
                <span
                  ref={countUpRef}
                  className="text-6xl text-black font-bold mb-3"
                />
